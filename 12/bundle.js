...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EVENT_TYPES, EVENT_CITIES, DESTINATION_DESCRIPTION, OPTION_NAMES, UpdateType, UserAction, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _model_trip_events_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/trip-events.js */ "./src/model/trip-events.js");
...
/* harmony import */ var _presenter_filters_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/filters.js */ "./src/presenter/filters.js");
/* harmony import */ var _mock_trip_event_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mock/trip-event.js */ "./src/mock/trip-event.js");
/* harmony import */ var _mock_event_options_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mock/event-options.js */ "./src/mock/event-options.js");
/* harmony import */ var _mock_destinations_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mock/destinations.js */ "./src/mock/destinations.js");
...
const eventOptions = Object(_mock_event_options_js__WEBPACK_IMPORTED_MODULE_6__["generateOptions"])();
const destinationsList = Object(_mock_destinations_js__WEBPACK_IMPORTED_MODULE_7__["generateDestinationsList"])();

const tripEvents = new Array(EVENT_COUNT)
  .fill()
  .map(() => Object(_mock_trip_event_js__WEBPACK_IMPORTED_MODULE_5__["generateTripEvent"])(eventOptions, destinationsList));

const tripEventsModel = new _model_trip_events_js__WEBPACK_IMPORTED_MODULE_2__["TripEventsModel"]();
tripEventsModel.setTripEvents(tripEvents);

const filtersModel = new _model_filters_js__WEBPACK_IMPORTED_MODULE_3__["FiltersModel"]();

const tripMainElement = document.querySelector(`.trip-main`);
const tripControlsElement = tripMainElement.querySelector(`.trip-controls`);
const tripsEventsElement = document.querySelector(`.trip-events`);

const tripPresenter = new _presenter_trip_js__WEBPACK_IMPORTED_MODULE_1__["TripPresenter"](tripsEventsElement, tripMainElement, tripEventsModel, filtersModel);
const filterPresenter = new _presenter_filters_js__WEBPACK_IMPORTED_MODULE_4__["FiltersPresenter"](tripControlsElement, filtersModel);

// Рендер меню

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(tripControlsElement, new _view_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["SiteMenuView"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
...
const generateTripEvent = (options, destinations) => {
  ...
  return {
    id: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["generateId"])(),
    type,
...
class FiltersPresenter {
  ...
  init() {
    ...
    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._filterContainer, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      return;
    }
...
class NewTripEventPresenter {
  ...
  init(eventOptions, destinationsList) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(this._tripEventsContainer, this._newTripEventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
  ...
  delete() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._newTripEventComponent);
    this._newTripEventComponent = null;
  ...
  _handleFormSubmit(tripEvent) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_TRIP_EVENT,
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
        Object.assign({id: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["generateId"])()}, tripEvent)
    );
    this.delete();
  }
...
class TripEventPresenter {
  ...
  init(tripEvent, eventOptions, destinationsList) {
    ...
    if (prevTripEventComponent === null || prevEventEditorComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["renderElement"])(this._tripEventsContainer, this._tripEventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._mode === Mode.DEFAULT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._tripEventComponent, prevTripEventComponent);
    }

    if (this._mode === Mode.EDITING) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventEditorComponent, prevEventEditorComponent);
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevTripEventComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevEventEditorComponent);
  }
  ...
  delete() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._tripEventComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._eventEditorComponent);
  }

  _replaceCardToForm() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventEditorComponent, this._tripEventComponent);
    document.addEventListener(`keydown`, this._escKeyDownHandler);
    this._changeMode();
  ...
  _replaceFormToCard() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._tripEventComponent, this._eventEditorComponent);
    document.removeEventListener(`keydown`, this._escKeyDownHandler);
    this._mode = Mode.DEFAULT;
  }
  ...
  _handleSubmitForm(update) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_TRIP_EVENT,
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR,
        update);
    this._replaceFormToCard();
  }
  ...
  _handleDeleteClick(tripEvent) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].DELETE_TRIP_EVENT,
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR,
        tripEvent
    );
  }
...
/* harmony import */ var _new_trip_event__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./new-trip-event */ "./src/presenter/new-trip-event.js");
...
/* harmony import */ var _route_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../route.js */ "./src/route.js");
/* harmony import */ var _utils_filters_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/filters.js */ "./src/utils/filters.js");
/* harmony import */ var _utils_sort_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/sort.js */ "./src/utils/sort.js");
/* harmony import */ var _view_trip_information_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../view/trip-information.js */ "./src/view/trip-information.js");
/* harmony import */ var _view_trip_price_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../view/trip-price.js */ "./src/view/trip-price.js");
...
class TripPresenter {
  constructor(tripContainer, tripDetailsContainer, tripEventsModel, filtersModel) {
    ...
    this._newTripEventPresenter = new _new_trip_event__WEBPACK_IMPORTED_MODULE_4__["NewTripEventPresenter"](this._eventsListComponent, this._handleViewAction);
  }

  init(eventOptions, destinationsList) {
    this._eventOptions = eventOptions.slice();
    this._destinationsList = destinationsList.slice();
    this._routeDetails = Object(_route_js__WEBPACK_IMPORTED_MODULE_7__["calculateRouteDetails"])(this._getTripEvents());
  ...
  createTripEvent() {
    this._currentSortType = `sort-day`;
    this._filtersModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_6__["FilterType"].EVERYTHING);
  ...
  _getTripEvents() {
    ...
    const filteredTripEvents = _utils_filters_js__WEBPACK_IMPORTED_MODULE_8__["filters"][filterType](tripEvents);

    switch (this._currentSortType) {
      case `sort-time`:
        return filteredTripEvents.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_9__["sortByDuration"]);
      case `sort-price`:
        return filteredTripEvents.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_9__["sortByPrice"]);
      case `sort-day`:
      default:
        return filteredTripEvents.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_9__["sortByDate"]);
    }
  }

  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["UserAction"].UPDATE_TRIP_EVENT:
        this._tripEventsModel.updateTripEvent(updateType, update);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["UserAction"].ADD_TRIP_EVENT:
        this._tripEventsModel.addTripEvent(updateType, update);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["UserAction"].DELETE_TRIP_EVENT:
  ...
  _renderSort() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._tripContainer, this._sortingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }

  _renderEventsList() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._tripContainer, this._eventsListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }

  _renderTripInformation() {
    this._tripInformationComponent = new _view_trip_information_js__WEBPACK_IMPORTED_MODULE_10__["TripInformationView"](this._routeDetails);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._tripDetailsContainer, this._tripInformationComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].AFTERBEGIN);
  }

  _renderTripPrice() {
    this._tripPriceComponent = new _view_trip_price_js__WEBPACK_IMPORTED_MODULE_11__["TripPriceView"](this._routeDetails);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._tripInformationComponent, this._tripPriceComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }

  _renderTripEvent(tripEvent, eventOptions, destinationsList) {
    const tripEventPresenter = new _trip_event_js__WEBPACK_IMPORTED_MODULE_3__["TripEventPresenter"](this._eventsListComponent, this._handleViewAction, this._handleModeChange);
  ...
  _renderNoEvent() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._tripContainer, this._noEventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }
  ...
  _clearTrip({resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._sortingComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._noEventComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._tripInformationComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._tripPriceComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._eventsListComponent);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomItemFromArray, getRandomItemsFromArray, generateId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***************************!*\
  !*** ./src/utils/sort.js ***!
  \***************************/
/*! exports provided: sortByDuration, sortByPrice, sortByDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createEventEditorTemplate = (data, optionsList, destinationsList) => {
  ...
  const createEventTypesList = (editingEventType) => {
    ...
    for (const eventType of _const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"]) {
      eventTypesList += `
              ...
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  ...
                  <div class="event__field-group  event__field-group--destination">
                    ...
                    <input class="event__input  event__input--destination" id="event-destination-2" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(destination.city)}" list="destination-list-2">
...
class EventEditorView extends _smart_js__WEBPACK_IMPORTED_MODULE_3__["SmartView"] {
  ...
  _setStartDatepicker() {
    ...
    this._startDatepicker = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(
  ...
  _setFinishDatepicker() {
    ...
    this._finishDatepicker = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(
...
const createSortingTemplate = (currentSortType) => {
  return `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item--day">
              ...
              name="trip-sort"
              value="sort-day"
              ${currentSortType === `sort-day` ? `checked` : ``}>
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              ...
              name="trip-sort"
              value="sort-time"
              ${currentSortType === `sort-time` ? `checked` : ``}>
            ...
            <div class="trip-sort__item  trip-sort__item--price">
              ...
              name="trip-sort"
              value="sort-price"
              ${currentSortType === `sort-price` ? `checked` : ``}>
