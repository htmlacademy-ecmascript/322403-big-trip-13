...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_trip_information__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/trip-information */ "./src/view/trip-information.js");
/* harmony import */ var _view_trip_price__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/trip-price */ "./src/view/trip-price.js");
...
/* harmony import */ var _view_events_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/events-list */ "./src/view/events-list.js");
/* harmony import */ var _view_event_editor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/event-editor */ "./src/view/event-editor.js");
/* harmony import */ var _view_trip_event__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/trip-event */ "./src/view/trip-event.js");
/* harmony import */ var _view_no_event__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./view/no-event */ "./src/view/no-event.js");
/* harmony import */ var _mock_trip_event__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mock/trip-event */ "./src/mock/trip-event.js");
/* harmony import */ var _mock_event_options__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./mock/event-options */ "./src/mock/event-options.js");
/* harmony import */ var _route__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./route */ "./src/route.js");
...
const eventOptions = Object(_mock_event_options__WEBPACK_IMPORTED_MODULE_10__["generateOptions"])();
const tripEvents = new Array(EVENT_COUNT)
  .fill()
  .map(() => Object(_mock_trip_event__WEBPACK_IMPORTED_MODULE_9__["generateTripEvent"])(eventOptions))
...
Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(tripControlsElement, new _view_site_menu__WEBPACK_IMPORTED_MODULE_2__["SiteMenuView"](), _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);

// Рендер фильтра

Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(tripControlsElement, new _view_filters__WEBPACK_IMPORTED_MODULE_3__["FiltersView"](), _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);

const renderTrip = (events) => {

  if (events.length === 0) {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(tripsEventsElement, new _view_no_event__WEBPACK_IMPORTED_MODULE_8__["NoEvent"](), _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
    return;
  }

  const routeDetails = Object(_route__WEBPACK_IMPORTED_MODULE_11__["calculateRouteDetails"])(events);

  // Рендер информации о путешествии

  const tripInformationComponent = new _view_trip_information__WEBPACK_IMPORTED_MODULE_0__["TripInformationView"](routeDetails);

  Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(tripMainElement, tripInformationComponent, _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].AFTERBEGIN);

  // Рендер цены

  Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(tripInformationComponent, new _view_trip_price__WEBPACK_IMPORTED_MODULE_1__["TripPriceView"](routeDetails), _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);

  // Рендер сортировки

  Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(tripsEventsElement, new _view_sorting__WEBPACK_IMPORTED_MODULE_4__["SortingView"](), _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);

  // Рендер списка событий

  const eventListComponent = new _view_events_list__WEBPACK_IMPORTED_MODULE_5__["EventsListView"]();

  Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(tripsEventsElement, eventListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);

  // Рендер точек маршрута

  const renderTripEvent = (eventListElement, tripEvent) => {
    const tripEventComponent = new _view_trip_event__WEBPACK_IMPORTED_MODULE_7__["TripEventView"](tripEvent);
    const eventEditorComponent = new _view_event_editor__WEBPACK_IMPORTED_MODULE_6__["EventEditorView"](tripEvent, eventOptions);

    const replaceCardToForm = () => {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["replace"])(eventEditorComponent, tripEventComponent);
    };

    const replaceFormToCard = () => {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["replace"])(tripEventComponent, eventEditorComponent);
    };
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["renderElement"])(eventListElement, tripEventComponent, _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
  };
...
const generateOptions = () => {
  let result = [];
  for (const type of _const__WEBPACK_IMPORTED_MODULE_0__["EVENT_TYPES"]) {
    for (const name of Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomItemsFromArray"])(_const__WEBPACK_IMPORTED_MODULE_0__["OPTION_NAMES"], 4, _const__WEBPACK_IMPORTED_MODULE_0__["OPTION_NAMES"].length)) {
      result.push({
        type,
        name,
        price: Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(20, 200)
      });
    }
  }
...
const generatePhotos = () => {
  ...
  return new Array(Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, 5)).fill().map(getPhoto);
};
...
const generateDate = () => {
  ...
  const hourGap = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(-maxHourGap, maxHourGap);

  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()()
    .add(daysGap, `day`)
    .add(hourGap, `hour`)
    .set(`minute`, Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomItemFromArray"])([0, 30]))
    .toDate();
};


const generateTripEvent = (options) => {
  const type = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomItemFromArray"])(_const__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"]);
  const start = generateDate();
  const getFinishDate = (startDate) => {
    return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDate).add(Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, 5), `hour`).toDate();
  };

  return {
    type,
    price: Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(50, 500),
    destination: {
      city: Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomItemFromArray"])(_const__WEBPACK_IMPORTED_MODULE_2__["EVENT_CITIES"]),
      description: Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomItemsFromArray"])(_const__WEBPACK_IMPORTED_MODULE_2__["DESTINATION_DESCRIPTION"], 1, 5),
    ...
    options: Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomItemsFromArray"])(options.filter((option) => option.type === type), 0, 5),
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomItemFromArray, getRandomItemsFromArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, renderElement, createElement, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const renderElement = (container, element, place) => {
  if (container instanceof _view_abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"]) {
    container = container.getElement();
  }

  if (element instanceof _view_abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"]) {
...
const replace = (newChild, oldChild) => {
  if (oldChild instanceof _view_abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"]) {
    oldChild = oldChild.getElement();
  }

  if (newChild instanceof _view_abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"]) {
...
const createEventEditorTemplate = (tripEvent, optionsList) => {
  ...
  const createEventTypesList = (editingEventType) => {
    ...
    for (const eventType of _const__WEBPACK_IMPORTED_MODULE_1__["EVENT_TYPES"]) {
      eventTypesList += `
  ...
  const createDestinationList = () => {
    let cities = ``;
    for (const city of _const__WEBPACK_IMPORTED_MODULE_1__["EVENT_CITIES"]) {
...
class EventEditorView extends _abstract__WEBPACK_IMPORTED_MODULE_2__["AbstractView"] {
...
class EventsListView extends _abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"] {
  getTemplate() {
...
class FiltersView extends _abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"] {
  getTemplate() {
...
class NoEvent extends _abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"] {
  getTemplate() {
...
class SiteMenuView extends _abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"] {
  getTemplate() {
...
class TripEventView extends _abstract__WEBPACK_IMPORTED_MODULE_1__["AbstractView"] {
...
class TripInformationView extends _abstract__WEBPACK_IMPORTED_MODULE_1__["AbstractView"] {
...
class TripPriceView extends _abstract__WEBPACK_IMPORTED_MODULE_0__["AbstractView"] {
  constructor(routeDetails) {
    super();
    this._routeDetails = routeDetails;
  }
